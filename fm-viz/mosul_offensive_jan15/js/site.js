...
function generateMap(){
   ...
   gMap.append("text")
        .attr("x",0)
        .attr("y",300)
        .text("Number of Families Fled")
        .attr("font-size","12px");

    gMap.append("text")
        .attr("x",0)
        .attr("y",313)
        .text("from Ninawa Governorate")
        .attr("font-size","12px");
...
function transitionMap(){
    $('#week1').html("<h3>Number of Families Who Have Fled from Ninawa Governorate</h3>");
...
$('#week1').html("<h3>Heat Map of Number of Families Fleed from Ninawa Governorate" + " in the two week period of " + mapSettings[currentWeek].Date + "</h3>" );
mapswitch = 'all';
transitionMap();
